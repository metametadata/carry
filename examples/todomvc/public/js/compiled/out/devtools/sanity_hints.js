...
var reader = (function (){var or__16751__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__16751__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__16751__auto__)){
return or__16751__auto__;
} else {
return (128);
...
var map__18386 = top_item;
var map__18386__$1 = ((((!((map__18386 == null)))?((((map__18386.cljs$lang$protocol_mask$partition0$ & (64))) || (map__18386.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__18386):map__18386);
var file = cljs.core.get.call(null,map__18386__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18386__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18386__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.sanity_hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e18385){var _e = e18385;
return false;
}});
...
var temp__4425__auto___18388 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4425__auto___18388)){
var sense_18389 = temp__4425__auto___18388;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_18389)].join('');
} else {
}
}
} else {
...
if(cljs.core.truth_((function (){var and__16739__auto__ = cljs.core.not.call(null,devtools.sanity_hints._STAR_installed_QMARK__STAR_);
...
//# sourceMappingURL=sanity_hints.js.map?rel=1456150484809