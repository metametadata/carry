...
var m__17407__auto__ = (schema.spec.core.subschemas[goog.typeOf(x__17406__auto__)]);
if(!((m__17407__auto__ == null))){
return m__17407__auto__.call(null,this$);
} else {
var m__17407__auto____$1 = (schema.spec.core.subschemas["_"]);
...
var x__17406__auto__ = (((this$ == null))?null:this$);
var m__17407__auto__ = (schema.spec.core.checker[goog.typeOf(x__17406__auto__)]);
if(!((m__17407__auto__ == null))){
return m__17407__auto__.call(null,this$,params);
} else {
var m__17407__auto____$1 = (schema.spec.core.checker["_"]);
if(!((m__17407__auto____$1 == null))){
return m__17407__auto____$1.call(null,this$,params);
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__18158,p__18159){
var map__18164 = p__18158;
...
var schema__$1 = cljs.core.get.call(null,map__18164__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.call(null,map__18164__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__18165 = p__18159;
...
var subschema_checker = cljs.core.get.call(null,map__18165__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.call(null,map__18165__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache.call(null,cache,schema__$1,((function (map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache){
return (function (x){
return cljs.core.deref.call(null,d).call(null,x);
});
;})(map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache))
});})(map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache))
,((function (map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache){
return (function (){
return subschema_checker.call(null,schema__$1,params);
});})(map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache))
);
if(cljs.core.truth_(error_wrap)){
return ((function (sub,map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache){
return (function (x){
...
;})(sub,map__18164,map__18164__$1,schema__$1,error_wrap,map__18165,map__18165__$1,params,subschema_checker,cache))
} else {
return sub;
}
});

//# sourceMappingURL=core.js.map?rel=1456096249030