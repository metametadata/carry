...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__18897__auto__,writer__18898__auto__,opt__18899__auto__){
return cljs.core._write.call(null,writer__18898__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__87321 = o;
(G__87321[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__87322__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__87322 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__87323__i = 0, G__87323__a = new Array(arguments.length -  0);
while (G__87323__i < G__87323__a.length) {G__87323__a[G__87323__i] = arguments[G__87323__i + 0]; ++G__87323__i;}
  args = new cljs.core.IndexedSeq(G__87323__a,0);
} 
return G__87322__delegate.call(this,args);};
G__87322.cljs$lang$maxFixedArity = 0;
G__87322.cljs$lang$applyTo = (function (arglist__87324){
var args = cljs.core.seq(arglist__87324);
return G__87322__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__18286__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18286__auto__){
var and__18286__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18286__auto____$1){
var and__18286__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__87329 = jsprops;
(G__87329["defaultValue"] = value);

(G__87329["onChange"] = ((function (G__87329,v,value,on_change){
return (function (p1__87327_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__87327_SHARP_);
});})(G__87329,v,value,on_change))
);
...
var vec__87334 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__87334,(0),null);
var id = cljs.core.nth.call(null,vec__87334,(1),null);
var class$ = cljs.core.nth.call(null,vec__87334,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___87337 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___87337 == null)){
} else {
var key_87338 = temp__4661__auto___87337;
(jsprops["key"] = key_87338);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__87340 = (new reagent.impl.template.NativeWrapper());
(G__87340["name"] = c);
...
var len__19357__auto___87346 = arguments.length;
var i__19358__auto___87347 = (0);
while(true){
if((i__19358__auto___87347 < len__19357__auto___87346)){
args__19364__auto__.push((arguments[i__19358__auto___87347]));

var G__87348 = (i__19358__auto___87347 + (1));
i__19358__auto___87347 = G__87348;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19365__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq87344){
var G__87345 = cljs.core.first.call(null,seq87344);
var seq87344__$1 = cljs.core.next.call(null,seq87344);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__87345,seq87344__$1);
});
...
break;
default:
var G__87352 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__87352;
continue;
...
var n__19202__auto___87353 = a.length;
var i_87354 = (0);
while(true){
if((i_87354 < n__19202__auto___87353)){
(a[i_87354] = reagent.impl.template.as_element.call(null,(a[i_87354])));

var G__87355 = (i_87354 + (1));
i_87354 = G__87355;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19202__auto___87356 = a.length;
var i_87357 = (0);
while(true){
if((i_87357 < n__19202__auto___87356)){
var val_87358 = (a[i_87357]);
if((cljs.core.vector_QMARK_.call(null,val_87358)) && ((reagent.impl.template.key_from_vec.call(null,val_87358) == null))){
(o["no-key"] = true);
} else {
}

(a[i_87357] = reagent.impl.template.as_element.call(null,val_87358));

var G__87359 = (i_87357 + (1));
i_87357 = G__87359;
continue;
} else {
}
...
var ctx = {};
var vec__87361 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__87361,(0),null);
var derefed = cljs.core.nth.call(null,vec__87361,(1),null);
...
var G__87363 = (cljs.core.count.call(null,argv) - first_child);
switch (G__87363) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__87363){
...
//# sourceMappingURL=template.js.map?rel=1460037778200